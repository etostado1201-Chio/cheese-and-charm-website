    ...
    <header id="top" className="mx-auto max-w-[1320px] px-8 pt-20 pb-[100px]">
      <div className="grid items-center gap-20 lg:grid-cols-[1.05fr_1fr]">
        <div>
          ...
          >
            <span className="font-script" style={{ fontSize: "1.05em" }}>
              Cheese
            </span>
            <span style={{ fontSize: "0.55em", verticalAlign: "0.18em" }}>
              {" "}&amp;{" "}
            </span>
            <span className="font-script" style={{ fontSize: "1.05em" }}>
              Charm
...
<div className="mt-8 flex items-center gap-4">
            ...
            <a href="#menu" className="rounded-full border border-line px-[22px] py-3 text-[13px] text-ink transition-all hover:border-ink hover:bg-[var(--color-bg-alt)]">{t(lang, COPY.cta_explore)} →</a>
          </div>
        ...
        <div className="relative">
          <div className="overflow-hidden rounded-[2px]" style={{ aspectRatio: "4 / 5" }}>
            <Image
              ...
              alt={lang === "es" ? "Tabla de charcuteria signature" : "Signature charcuterie board"}
              width={800}
              height={1000}
              priority
          ...
          <div className="cc-spin absolute -bottom-9 -left-9 flex h-40 w-40 items-center justify-center rounded-full border border-line bg-white">
            <div className="flex flex-col items-center text-center">
              ...
              <span className="mt-1 font-script text-[28px] leading-none text-ink">
                Cheese &amp; Charm
              </span>
              <span className="mt-1 font-mono text-[9px] uppercase tracking-widest text-ink-mute">
                — DFW —
              </span>
            </div>
          </div>
